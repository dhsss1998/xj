                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li class="">
                        ...
                        <ul class="mm-collapse">
                            <li><a href="${cx}/student/create1" id="Item1_1">
                                添加学生信息</a></li>
                            ...
                            <li><a href="${cx}/student/query" id="Item1_3">
                                查询学生信息</a></li>
                            <li><a href="${cx}/student/query0" id="Item1_4">
                                查询学生学分</a></li>
                            <li><a href="${cx}/student/test" id="Item1_5">
                                查询学生奖惩</a></li>
                        </ul>
                    </li>
                    <li>
